    ...
    <div>
      <div class="container flex border">
        <div class="login " style="height:fit-content; margin-bottom: 1em;">
            <div class="flex al-cent h3 flex-basis-100 jc-cent"><h1 style="color: rgb(106, 201, 201);">Login to Meeting app</h1></div>
            ...
            <div class="flex jc-cent p1"><h4 class="opa">or use your email id to login</h4></div>
            
            <form class="flex jc-cent" id="form-login" action="" @submit.prevent="login">
                ...
                <div class="flex jc-cent opa m1 p1" >
                    <input type="password" name="mail" id="password-input" placeholder="Password" v-model="form.password" @blur="$v.form.password.$touch()">
                </div>
                ...
                <div class="flex jc-cent opa m1 ">
                    <div class="buttondiv">
                        <input type="Submit" name="submit" value="Login" class="color button" >
                    </div>
                </div>
            ...
            <div class="newhere  color">
                ...
                <div class="margin-top">
                    <div class="flex jc-cent">
                        <div class="rvcolor "><h1>New here?</h1></div>
                    </div>
                    <div class="flex jc-cent al-cent m-1 ">
                        <div class="rvcolor ml"><h3>Share your details and create an account.</h3></div>
                    </div>
                    <div class="flex jc-cent m-1">
                        <div class="buttondiv ">
                            <router-link to="/register" class="link-plain">
                                <input type="Submit" name="submit" value="Register" class="button color rvcolor">
                            </router-link>
                        </div>
                    </div>
                </div>
